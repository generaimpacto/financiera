...
import { updateExpenseAction, getExpenseAction } from './actions'
...
export default function EditExpensePage() {
    ...
    if (!initialData && !error) return <div className="p-8 text-center text-secondary"><Loader2 className="animate-spin text-red-500 inline-block mr-2" />Cargando...</div>
    ...
    return (
        <div className="animate-fade-in max-w-2xl mx-auto">
            <header className="mb-8 flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-red-400 to-rose-400">
                        Editar Egreso
                    </h1>
                    <p className="text-secondary mt-1">Modifica los detalles del gasto</p>
                </div>
            </header>
